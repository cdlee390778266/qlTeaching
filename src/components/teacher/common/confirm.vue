<template>
  <div>
    <div class="flt promptFlt delflt" opertype="DEL">
      <h3>
        <span class="fl">提示</span>
        <a href="javascript:void(0)" class="closed" @click="close"></a>
      </h3>
      <div class="detail">
        <p class="center"><i></i><span>{{content ? content : '确定删除吗?'}}</span></p>
      </div>
      <div class="btns">
        <a href="javascript:void(0)" class="btn confirm" @click="confirm">确定</a>
