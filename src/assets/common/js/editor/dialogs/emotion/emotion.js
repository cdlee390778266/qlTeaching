(function () {
    ...
    var hostPathName = (localhostPaht + projectName) + "/student/";
    ...
    UM.registerWidget('emotion', {
        ...
        sourceData: {
            emotion: {
                ...
                SmileyInfor: {
                    'edui-emotion-Jtab0': ['Kiss', 'Love', 'Yeah', '啊！', '背扭', '顶', '抖胸', '88', '汗', '瞌睡', '鲁拉', '拍砖', '揉脸', '生日快乐', '大笑', '瀑布汗~', '惊讶', '臭美', '傻笑', '抛媚眼', '发怒', '打酱油', '俯卧撑', '气愤', '?', '吻', '怒', '胜利', 'HI', 'KISS2', '不说', '不要', '扯花', '大心', '顶2', '大惊', '飞吻', '鬼脸', '害羞', '口水', '狂哭', '来', '发财了', '吃西瓜', '套牢', '害羞2', '庆祝', '我来了', '敲打', '晕了', '胜利2', '臭美2', '被打了', '贪吃', '迎接', '酷', '微笑', '亲吻', '调皮', '惊恐', '耍酷', '发火', '害羞3', '汗水', '大哭', '得意', '加油', '困', '你NB', '晕倒', '开心', '偷笑', '大哭', '滴汗', '叹气', '超赞', '??', '飞吻3', '天使', '撒花', '生气3', '被砸', '吓傻', '随意吐'],
                    ...
                    'edui-emotion-Jtab2': ['大笑', '瀑布汗~', '惊讶', '臭美', '傻笑', '抛媚眼', '发怒', '我错了', 'money', '气愤', '挑逗', '吻', '怒', '胜利', '委屈', '受伤', '说啥呢？', '闭嘴', '不', '逗你玩儿', '飞吻', '眩晕', '魔法', '我来了', '睡了', '我打', '闭嘴2', '打', '打晕了', '刷牙', '爆揍', '炸弹', '倒立', '刮胡子', '邪恶的笑', '不要不要', '爱恋中', '放大仔细看', '偷窥', '超高兴', '晕', '松口气', '我跑', '享受', '修养', '哭', '汗2', '啊~', '热烈欢迎', '打酱油', '俯卧撑', '吸鼻'],
                    'edui-emotion-Jtab3': ['HI', 'KISS2', '不说', '不要', '扯花', '大心', '顶2', '大惊', '飞吻2', '鬼脸', '害羞', '口水', '狂哭', '来', '泪眼', '流泪', '生气', '吐舌', '喜欢', '旋转2', '再见', '抓狂', '汗3', '鄙视', '拜', '吐血', '嘘', '打人', '蹦跳', '变脸', '扯肉', '吃To', '吃花', '吹泡泡糖', '大变身', '飞天舞', '回眸', '可怜', '猛抽', '泡泡', '苹果', '亲', '滚地', '骚舞', '烧香', '睡', '套娃娃', '捅捅', '舞倒', '西红柿', '爱慕', '摇', '摇摆', '杂耍', '招财', '被殴', '被球闷', '大惊2', '理想', '欧打', '呕吐', '碎', '吐痰'],
                    'edui-emotion-Jtab4': ['发财了', '吃西瓜', '套牢', '害羞2', '庆祝', '我来了', '敲打', '晕了', '胜利2', '臭美2', '被打了', '贪吃', '迎接', '酷', '顶3', '幸运', '爱心', '躲', '送花', '选择'],
                    'edui-emotion-Jtab5': ['微笑', '亲吻', '调皮', '惊讶2', '耍酷', '发火', '害羞3', '汗水', '大哭', '得意', '鄙视2', '困', '夸奖', '晕倒', '疑问', '媒婆', '狂吐', '青蛙', '发愁', '亲吻2', '满足', '爱心2', '心碎', '玫瑰', '礼物', '哭', '奸笑', '可爱', '得意2', '呲牙', '暴汗', '楚楚可怜', '困2', '哭2', '生气2', '惊讶3', '口水2', '彩虹', '夜空', '太阳', '钱钱', '灯泡', '咖啡', '蛋糕', '音乐', '爱', '胜利3', '赞', '鄙视3', 'OK'],
                    'edui-emotion-Jtab6': ['男兜', '女兜', '开心', '乖乖', '偷笑', '大笑2', '抽泣', '大哭2', '无奈', '滴汗', '叹气', '狂晕', '委屈2', '超赞', '囧', '疑问2', '飞吻3', '天使', '撒花', '生气3', '被砸', '口水3', '泪奔', '吓傻', '吐舌头', '点头', '随意吐', '旋转3', '困困', '鄙视4', '狂顶', '篮球', '再见2', '欢迎光临', '恭喜发财', '稍等', '我在线', '恕不议价', '库房有货', '货在路上']
                }
            }
        },
        initContent: function (_editor, $widget) {
            ...
            emotion.SmileyPath = _editor.options.emotionLocalization === true ? emotionUrl + 'images/' : hostPathName + "images/hi/";
...
//                    realUrl = $td.attr('data-realurl') || null;
                realUrl = $td.children(0).children(0).attr('title') || null; //取当前被点击表情的title值
